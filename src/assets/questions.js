...
export const Geek = [
  {
    question:
      "In the Star Wars saga, who is the Sith Lord, ruling with an iron fist and seeking to eradicate the Jedi Order?",
    A: "Darth Vader",
    B: "Darth Sidious",
    C: "Darth Maul",
    D: "Count Dooku",
  ...
  {
    question:
      "In Marvel Comics, who is the powerful mutant telepath who often serves as the primary adversary of the X-Men?",
    A: "Mystique",
    B: "Apocalypse",
    C: "Magneto",
    D: "Juggernaut",
  ...
  {
    question:
      "What is the villainous alter ego of Norman Osborn, a wealthy industrialist and Spider-Man's archenemy in Marvel Comics?",
    A: "The Riddler",
    B: "Venom",
    C: "Green Goblin",
    D: "Doctor Octopus",
  ...
  {
    question:
      "What is the name of Saruman's stronghold, where he plots against the forces of good?",
    A: "Minis Tirith",
    B: "Isengard",
    C: "Helm's Deep",
    D: "Mordor",
...
export const Tech = [
  ...
  },
  {
    ...
    A: "Hyper Technology Protocol",
    B: "Humble Terminal Parameter",
    C: "HyperText Transfer Protocol",
    D: "Hydrogen Toxic Perimeter",
    answer: "C",
  },
  {
  ...
  },
  {
    ...
    B: "Capacity Performance Unit",
    C: "Central Pattern Unit",
    D: "Cosmos Processing Untitled",
    answer: "A",
  },
  {
    question:
  ...
  {
    question:
      "In what year was the World Wide Web invented, revolutionizing the way information is shared on the internet?",
    A: "1979",
    B: "1984",
    C: "1989",
    D: "1991",
...
export const Music = [
  {
    question:
      "What Swedish band is famous for winning the 1974 Eurovision with Waterloo?",
    A: "The Cardigans",
    B: "Abba",
    C: "Ace of Base",
    D: "Roxette",
  ...
  {
    question: "What band released the 1969 album Abbey Road?",
    A: "The Monkeys",
    B: "The Specials",
    C: "The Cardigans",
    D: "The Beatles",
  ...
  },
  {
    ...
    A: "Thriller",
    B: "Abbey Road",
    C: "Sgt. Peppers Lonely Hearts Club Band",
    D: "The Dark Side of the Moon",
    answer: "A",
  },
  {
    question:
      "What name do the home of Elvis Presley and Paul Simon album share?",
    A: "Nashville",
    B: "Graceland",
    C: "Wonderland",
    D: "Disneyland",
  ...
  {
    question:
      "What band that had a hit with Feel Good Inc. is made up of entirely virtual members?",
    A: "The Killers",
    B: "Beck",
    C: "Gorillaz",
    D: "Beastie Boys",
  ...
  {
    question:
      "What Killers song has been in the U|K charts for over 260 weeks since its release back in 2004?",
    A: "Read My Mind",
    B: "Somebody Told Me",
  ...
  {
    question:
      "What English rock band were infamous for smashing up hotel rooms and musical equipment?",
    A: "The Beatles",
  ...
  {
    question:
      "Identify the band from its members - Mick, Christine, John, Stevie, and Lindsey?",
    A: "Fleetwood Mac",
    B: "The Beatles",
    C: "The Who",
    D: "Led Zeppelin",
  ...
  {
    question:
      "Red Hot Chilli Peppers bass guitarist flea originally began playing what orchestral instrument?",
    A: "Trumpet",
    B: "Violin",
    C: "Harp",
    D: "Cello",
  ...
  {
    question:
      "Who performed the title song for the James Bond movie Skyfall?",
    A: "Beyoncé",
    B: "Norah Jones",
    C: "Prince",
    D: "Adele",
  ...
  {
    question: "Nirvana’s former drummer went on to found what band?",
    A: "Queens of Stone Age",
    B: "Foo Fighters",
    C: "Green Day",
    D: "Velvet Revolver",
    answer: "B",
  ...
  {
    question:
      "Made famous by Whitney Houston in the movie The Bodyguard, who originally recorded ‘I Will Always Love You’?",
    A: "Aretha Franklin",
    B: "Tina Turner",
    C: "Dolly Parton",
    D: "Ella Fitzgerald",
  ...
  {
    question:
      "What icon famously turned down the chance to perform at Live Aid?",
    A: "Prince",
    B: "Queen",
    C: "Eric Clapton",
    D: "Jimi Hendrix",
  ...
  {
    question: "Where is the Rock & Roll Hall of Fame located?",
    A: "Cleveland, Ohio",
    B: "Los Angeles",
    C: "New York City",
    D: "Chicago",
  ...
  {
    question:
      "What was the title of the Annie Lennox song that won an Oscar for The Lord of the Rings: Return of the King?",
    A: "Into the West",
    B: "I put a spell on you",
    C: "Here Comes the rain again",
    D: "Sweet Dreams",
    answer: "A",
  },
  {
    question: "What is U2 lead singer Bono’s real name?",
    A: "Paul Hewson",
    B: "Paul Simon",
    C: "Paul Stanley",
    D: "Paul Newman",
  ...
  {
    question:
      "Identify the band from its members  - Barry, Robin, Maurice?",
    A: "The Beatles",
    B: "The Specials",
    C: "The Bee Gees",
    D: "The Who",
  ...
  {
    question: "In what country was Freddie Mercury born?",
    A: "UK",
    B: "Argentina",
    C: "South Africa",
    D: "Tanzania / Zanzibar",
  ...
  {
    question:
      "Who is the only person to be inducted into the Rock and Roll Hall of Fame 3 times (hint - once as a solo artist and twice in bands)?",
    A: "Eric Clapton",
    B: "Santana",
  ...
  {
    question:
      "In what year did Jimi Hendrix pass away at the age of 27?",
    A: "1967",
    B: "1969",
    C: "1970",
    D: "1971",
  ...
  {
    question:
      "Who was the lead vocalist of the band Led Zeppelin, known for his powerful voice and charismatic stage presence?",
    A: "Roger Daltrey",
    B: "Freddie Mercury",
    C: "Mick Jagger",
    D: "Robert Plant",
